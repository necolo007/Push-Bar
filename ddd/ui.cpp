...
void initUIResources() {
    loadimage(&img_wall, "res/wall.png");
    loadimage(&img_box, "res/box.png");
    loadimage(&img_player, "res/player.png");
    loadimage(&img_goal, "res/goal.png");
    loadimage(&img_box_on_goal, "res/box_on_goal.png");
    loadimage(&img_player_on_goal, "res/player_on_goal.png");
    loadimage(&img_floor, "res/floor.png");
    loadimage(&img_player_front, "res/player_front.png");
    loadimage(&img_player_back, "res/player_back.png");
    loadimage(&img_player_left, "res/player_left.png");
    loadimage(&img_player_right, "res/player_right.png");
    loadimage(&img_player_front_walk1, "res/player_front_walk1.png");
    loadimage(&img_player_front_walk2, "res/player_front_walk2.png");
    loadimage(&img_player_back_walk1, "res/player_back_walk1.png");
    loadimage(&img_player_back_walk2, "res/player_back_walk2.png");
    loadimage(&img_player_left_walk, "res/player_left_walk.png");
    loadimage(&img_player_right_walk, "res/player_right_walk.png");
}
